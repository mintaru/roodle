...
<div class="container" style="max-width: 700px; margin: 40px auto;">
    ...
    <form action="{{ route('assignments.store', $course) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea id="instructions" name="instructions" placeholder="Опишите, что должны сделать ученики...">{{ old('instructions') }}</textarea>
            @error('instructions')
                <div class="error-message">{{ $message }}</div>
            @enderror
        </div>
