...
<head>
    ...
    <title>Создать задание — {{ $course->title }}</title>
    ...
    <main class="main">
        ...
        <div style="max-width: 760px;">
            ...
            <div class="panel" style="padding: 2rem;">
                ...
                <form
                    action="{{ route('assignments.store', $course) }}"
                    method="POST"
                            ...
                            <template x-if="files.length === 0">
                                ...
                                <div>
                                    ...
                                    <p style="
                                        ...
                                        margin-top: 12px;
                                    ">
                                        Можно загрузить несколько файлов · до 100 МБ каждый
                                    </p>
            ...
            ">
                ...
                <p style="
                    ...
                    line-height: 1.5;
                ">
                    После создания задание сразу станет доступно студентам курса.
                </p>
