...
<head>
    ...
    <style>
        ...
        .tq-back:hover { background: var(--gray-100); color: var(--gray-800); }

        .tq-header { margin-bottom: 2rem; }
        .tq-header__eyebrow {
            font-size: 12px;
            font-weight: 700;
        ...
        .tq-add-btn:hover { background: var(--teal-600); transform: translateY(-1px); }
        ...
        .tq-row:hover { background: var(--gray-50); }
        ...
        .tq-type--single   { background: var(--teal-50);  color: var(--teal-700); }
        .tq-type--multiple { background: var(--sky-50);   color: var(--sky-700); }
        .tq-type--short    { background: var(--gray-100); color: var(--gray-600); }
        .tq-type--rich     { background: #f3f0ff;         color: #6d28d9; }
        .tq-type--dropdown { background: #fff7ed;         color: #c2410c; }

        .tq-row__actions { display: flex; align-items: center; gap: 4px; flex-shrink: 0; }
        ...
        .tq-icon-btn:hover { background: var(--gray-100); color: var(--gray-700); border-color: var(--gray-300); }
        .tq-icon-btn--delete:hover { background: #fff0f0; color: var(--red-500); border-color: #fecaca; }
        .tq-icon-btn svg { width: 15px; height: 15px; }
        ...
        .tq-page-input:focus { outline: none; border-color: var(--teal-400); box-shadow: 0 0 0 2px rgba(0,181,165,.1); }
        ...
        .tq-empty svg { margin-bottom: 12px; opacity: .25; }
        .tq-empty p { font-size: 14px; font-weight: 500; color: var(--color-text-secondary); margin-bottom: 4px; }
        .tq-empty span { font-size: 13px; color: var(--color-text-muted); }
        ...
        .modal__title { font-size: 16px; font-weight: 700; color: var(--gray-800); line-height: 1.3; }
        ...
        /* ─── ADD CHOICE ─── */
        .add-choice-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
        .add-choice-card {
            padding: 1.25rem;
        ...
        .add-choice-card:hover { border-color: var(--teal-400); background: var(--teal-50); }
        ...
        .aci--new  { background: var(--teal-50);  color: var(--teal-600); }
        .aci--bank { background: var(--sky-50);   color: var(--sky-600); }
        .add-choice-card__title { font-size: 14px; font-weight: 700; color: var(--gray-800); margin-bottom: 3px; }
        .add-choice-card__desc  { font-size: 12px; color: var(--color-text-muted); line-height: 1.4; }
        ...
        .detail-opts { list-style: none; display: flex; flex-direction: column; gap: 6px; }
        .detail-opt {
        ...
        .detail-blank__title { font-size: 12px; font-weight: 700; color: var(--teal-700); margin-bottom: 7px; }
        ...
        trix-editor:focus { outline: none !important; border-color: var(--teal-400) !important; }
        trix-toolbar {
            border: 1px solid var(--color-border);
            border-bottom: none;
        ...
        .opts-form { display: flex; flex-direction: column; gap: 7px; margin-bottom: 8px; }
        ...
        .add-opt-btn:hover { border-color: var(--teal-400); color: var(--teal-700); background: var(--teal-50); }
        ...
        .cbrow input { accent-color: var(--teal-500); width: 14px; height: 14px; }
        ...
        .ddb-block > label {
            ...
            color: var(--teal-700); margin-bottom: 7px;
        }
        .ddo-row { display: flex; align-items: center; gap: 8px; margin-bottom: 5px; }
        ...
        .ddo-row input[type="radio"] { accent-color: var(--teal-500); width: 14px; height: 14px; }
        ...
        .btn-primary:hover { transform: translateY(-1px); background: var(--teal-600); }
        .btn-primary:disabled { opacity:.6; cursor:not-allowed; transform:none; }
        .btn-danger { background: var(--red-500); box-shadow: none; }
        ...
        .alert-error {
            background: #fff0f0; border: 1px solid #fecaca; color: var(--red-500);
            border-radius: var(--r-md); padding: 10px 13px;
            font-size: 13px; margin-bottom: 1rem;
        }
        .alert-error strong { display: block; font-weight: 700; margin-bottom: 4px; }
        .alert-error ul { margin:0; padding-left:16px; }

        .modal::-webkit-scrollbar { width: 5px; }
        .modal::-webkit-scrollbar-thumb { background: var(--gray-200); border-radius: 3px; }
    </style>
</head>
<body>
    <header class="header">
                ...
                <li class="tq-row">
                    ...
                    @if ($test->display_mode === 'paged')
                        <input type="number" name="pages[{{ $question->id }}]" min="1"
                            ...
                            class="tq-page-input" title="Номер страницы">
                    @endif
            ...
            <form action="/tests/{{ $test->id }}/questions" method="POST" id="question-form">
                ...
                <div class="modal__body">
                    ...
                    <div class="ff" id="opts-group">
                        <label>Варианты <span style="font-weight:400;text-transform:none;letter-spacing:0;color:var(--color-text-muted);">(отметьте правильный)</span></label>
                        <div id="opts-container" class="opts-form">
                            <div class="opt-row"><input type="radio" name="correct_option" value="0"><input type="text" name="options[0]" placeholder="Вариант 1"></div>
                            <div class="opt-row"><input type="radio" name="correct_option" value="1"><input type="text" name="options[1]" placeholder="Вариант 2"></div>
                        </div>
                    ...
                    <div class="ff" id="text-ans-group" style="display:none;">
                        ...
                        <div id="text-ans-container" class="opts-form">
                            <div class="opt-row"><input type="text" name="correct_answers[0]" placeholder="Правильный ответ" required></div>
                        </div>
        ...
        <div class="modal modal--md">
            ...
            <form action="/tests/{{ $test->id }}/add-from-bank" method="POST">
                ...
                <div class="modal__body">
                    ...
                    <div class="ff">
                        <label>Вопросы</label>
                        <select name="question_id" required id="bank-select" size="9" style="height:auto;padding:0;">
                            @foreach ($allQuestions as $q)
                                <option value="{{ $q->id }}" data-q="{{ strtolower(strip_tags($q->question_text)) }}"
    ...
    @foreach ($test->questions as $q)
        <form id="del-form-{{ $q->id }}"
            action="{{ route('tests.removeQuestion', ['test' => $test->id, 'question' => $q->id]) }}"
    ...
    /* ── DELETE ── */
    let pendingDel = null;
    function askDelete(id) { pendingDel=id; openModal('modal-delete'); }
    ...
    /* ── DETAIL ── */
    const TYPE_LABELS = {
        single_choice:'Один правильный ответ', multiple_choice:'Несколько правильных ответов',
        short_answer:'Текстовый ответ', rich_text_answer:'Развёрнутый ответ',
    ...
    function openDetail(id) {
        ...
        if (q.type==='fill_in_dropdown') {
            ...
            Object.entries(q.options).forEach(([bId,opts])=>{
                h+=`<div class="detail-blank"><div class="detail-blank__title">Пропуск #${bId}</div><ul class="detail-opts">`;
                opts.forEach(o=>{
                    h+=`<li class="detail-opt${o.is_correct?' correct':''}"><div class="detail-opt__dot">${o.is_correct?checkSvg:''}</div>${o.text}</li>`;
                });
                h+=`</ul></div>`;
            });
            ...
            h+=`<div class="detail-section-label">Проверяется вручную</div><p style="font-size:13px;color:var(--color-text-muted);">Развёрнутые ответы оценивает преподаватель.</p>`;
        } else {
    ...
    function refreshUI() {
        ...
        if (t==='short_answer') {
            show(qTextGrp,1); show(optGrp,0); show(ansGrp,1); show(fillGrp,0);
            oi.forEach(i=>{i.required=false;i.removeAttribute('required');}); ai.forEach(i=>i.required=true);
        } else if (t==='rich_text_answer') {
            show(qTextGrp,1); show(optGrp,0); show(ansGrp,0); show(fillGrp,0);
            oi.forEach(i=>{i.required=false;i.removeAttribute('required');}); ai.forEach(i=>{i.required=false;i.removeAttribute('required');});
        } else if (t==='fill_in_dropdown') {
            show(qTextGrp,0); show(optGrp,0); show(ansGrp,0); show(fillGrp,1);
            ...
            show(qTextGrp,1); show(optGrp,1); show(ansGrp,0); show(fillGrp,0);
            oi.forEach(i=>{if(i.type==='text')i.required=true;}); ai.forEach(i=>{i.required=false;i.removeAttribute('required');});
            refreshOptInputs();
        }
    }
    function refreshOptInputs() {
        ...
        Array.from(optCont.children).forEach((div,i)=>{
            ...
            if(!inp)return;
            if(t==='single_choice'){inp.type='radio';inp.name='correct_option';inp.required=true;}
            else {inp.type='checkbox';inp.name='correct_options[]';inp.required=false;}
        });
    }
    function buildDropdownsUI() {
        ...
        const re=/\{(\d+)\}/g; let m; let blanks=[];
        while((m=re.exec(text))!==null){const i=parseInt(m[1]);if(!blanks.includes(i))blanks.push(i);}
        blanks.sort((a,b)=>a-b);
        const ex={};
        ...
        Object.keys(ex).forEach(i=>{if(!blanks.includes(parseInt(i)))ex[i].remove();});
        blanks.forEach(idx=>{
            if(ex[idx]){cont.appendChild(ex[idx]);return;}
            const block=document.createElement('div');
            block.className='ddb-block';
            block.innerHTML=`<label>Пропуск #${idx}: варианты (один правильный)</label>
                <div id="ddo-${idx}">
    ...
    document.getElementById('dropdowns-container').addEventListener('click', e=>{
        if(e.target.classList.contains('ddb-add')){
            ...
            const row=document.createElement('div'); row.className='ddo-row';
            row.innerHTML=`<input type="radio" name="dropdown_correct[${idx}]" value="${cnt}"><input type="text" name="dropdown_options[${idx}][]" placeholder="Вариант ${cnt+1}" required>`;
            div.appendChild(row);
        }
    });
    ...
    document.getElementById('add-opt-btn').addEventListener('click', ()=>{
        const idx=optCont.children.length; const t=qType.value;
        const it=t==='single_choice'?'radio':'checkbox';
        const na=t==='single_choice'?'correct_option':'correct_options[]';
        const row=document.createElement('div'); row.className='opt-row';
        row.innerHTML=`<input type="${it}" name="${na}" value="${idx}"><input type="text" name="options[${idx}]" placeholder="Вариант ${idx+1}" required>`;
    ...
    document.getElementById('add-ans-btn').addEventListener('click', ()=>{
        ...
        const row=document.createElement('div'); row.className='opt-row';
        row.innerHTML=`<input type="text" name="correct_answers[${idx}]" placeholder="Правильный ответ ${idx+1}" required>`;
    ...
    function upload(att) {
        const fd=new FormData(); fd.append('file',att.file);
        fetch("{{ route('questions.upload') }}", {
            method:'POST',
            headers:{'X-CSRF-TOKEN':document.querySelector('meta[name="csrf-token"]').content},
            body:fd, credentials:'same-origin'
        }).then(r=>r.json()).then(d=>{ if(d.location) att.setAttributes({url:d.location,href:d.location}); })
    ...
    /* ── AUTO-OPEN on errors ── */
    @if($errors->any()) openModal('modal-create');
    @endif
    </script>
</body>
</html>
